...
def test_FCO(step):
    ...
    world.output_file = test_pyGDP.submitFeatureCoverageOPenDAP(world.shapefile, world.dataSetURI, world.dataType,
                                                                world.timeStart, world.timeEnd, world.attribute,
                                                                world.value, verbose=False,
                                                                outputfname='testOPenDAP_testfile_test', sleepSecs=15)
