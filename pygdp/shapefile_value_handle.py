...
from pygdp.namespaces import upload_URL, WPS_URL, WPS_Service, CSW_URL  # WFS_URL,
from pygdp.namespaces import WPS_DEFAULT_VERSION, WPS_DEFAULT_SCHEMA_LOCATION, GML_SCHEMA_LOCATION
from pygdp.namespaces import GML_NAMESPACE, WPS_DEFAULT_NAMESPACE, CSW_NAMESPACE, WPS_DEFAULT_NAMESPACE, \
    WFS_NAMESPACE, OGC_NAMESPACE
