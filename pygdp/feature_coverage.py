...
def submitFeatureCategoricalGridCoverage(geoType, dataSetURI, varID, attribute='the_geom', value=None, gmlIDs=None,
                                         verbose=False, coverage='true', delim='COMMA', wfs_url=None,
...
def submitFeatureCoverageWCSIntersection(geoType, dataSetURI, varID, attribute='the_geom', value=None, gmlIDs=None,
                                         verbose=False, coverage='true', wfs_url=None, outputfname=None, sleepSecs=10):
    """
